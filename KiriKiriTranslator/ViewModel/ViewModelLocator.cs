/*
  ...
  <Application.Resources>
      <vm:ViewModelLocatorTemplate xmlns:vm="clr-namespace:KiriKiriTranslator.ViewModel"
                                   x:Key="Locator" />
  </Application.Resources>
...
namespace KiriKiriTranslator.ViewModel
{
    ...
    public class ViewModelLocator
    {
        static ViewModelLocator()
        {
            ...
            {
                SimpleIoc.Default.Register<IKKFile, Design.DesignDataService>();
            }
            else
            {
                SimpleIoc.Default.Register<IKKFile, KKFile>();
            }
